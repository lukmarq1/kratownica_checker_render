...
function UnlockButton({ ipAddress }: { ipAddress: string }) {
  ...
  return (
    <Button onClick={() => { if(confirm(`Odblokowac ${ipAddress}?`)) m.mutateAsync({ ipAddress }) }} disabled={m.isPending} size="sm" className="bg-orange-600 hover:bg-orange-700 text-white font-mono text-xs h-7 px-3">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1 font-mono">Historia prob</p>
          </div>
              ...
              <table className="w-full text-sm font-mono">
                <thead>
                  <tr className="border-b-2 border-slate-600">
                    ...
                    <th className="text-left py-3 px-3 text-slate-400">Kat</th>
                          ...
                          <div className="group relative inline-block">
                            ...
                            <div className="absolute left-0 top-full mt-3 hidden group-hover:block z-[9999] w- bg-[#1e293b] border border-[#334155] rounded- shadow-[0_20px_60px_rgba(0,0,0,0.5)] overflow-hidden">
                              ...
                              <div className="p-[10px_20px_0]">
                                <div className="flex justify-between py- gap-4"><span className="text- text-[#94a3b8]">{"\u{1F310}"} Przegladarka</span><span className="text-[12.5px] font-medium text-[#e2e8f0] text-right">{a.browserFamily || "\u2014"}</span></div>
                                ...
                                <div className="flex justify-between py- gap-4"><span className="text- text-[#94a3b8]">{"\u{1F4F1}"} Urzadzenie</span><span className="text-[12.5px] font-medium text-[#e2e8f0] text-right">{a.deviceType || "desktop"}</span></div>
                              </div>
